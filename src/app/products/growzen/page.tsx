    ...
    <main className="pt-24">
      ...
      <section className="border-b border-[#1E2E45] pb-16 pt-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          >
            ...
            <h1 className="mb-4 font-[family-name:var(--font-syne)] text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#F0F4FF]">
              GrowZen
            </h1>
            <p className="mb-3 font-[family-name:var(--font-syne)] text-lg sm:text-xl font-semibold text-[#2D7DFA] md:text-2xl">
              Complete Internal Operations for Growing Companies
            </p>
            <p className="mb-8 text-sm sm:text-base text-[#8B9AB5] font-[family-name:var(--font-dm-sans)] leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/contact"
                className="w-full sm:w-auto text-center rounded-md bg-[#2D7DFA] px-6 py-3 text-sm font-[family-name:var(--font-dm-sans)] font-medium text-white hover:bg-[#2D7DFA]/90 transition-colors"
              >
                Request a Demo
              </Link>
              <a
                href="#"
                className="w-full sm:w-auto text-center rounded-md border border-[#1E2E45] px-6 py-3 text-sm font-[family-name:var(--font-dm-sans)] font-medium text-[#F0F4FF] hover:border-[#2D7DFA]/50 hover:text-[#2D7DFA] transition-colors"
              >
                View Documentation
              </a>
            </div>
      ...
      <div className="mx-auto max-w-5xl px-6 py-20">
        ...
        >
          ...
          <div className="rounded-md border border-[#1E2E45] bg-[#0F1A2E] p-6 sm:p-8">
            <p className="mb-4 text-sm sm:text-base text-[#8B9AB5] font-[family-name:var(--font-dm-sans)] leading-relaxed">
        ...
        >
          ...
          <h2 className="mb-8 font-[family-name:var(--font-syne)] text-xl sm:text-2xl font-bold text-[#F0F4FF]">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {roles.map((role, i) => (
              ...
              >
                ...
                <p className="text-xs sm:text-sm text-[#8B9AB5] font-[family-name:var(--font-dm-sans)] leading-relaxed pl-3.5">
                  {role.description}
                </p>
              </motion.div>
            ))}
        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            {features.map((f) => (
              <span
                key={f}
                className="inline-flex items-center rounded-sm border border-[#1E2E45] bg-[#1A2740] px-3 py-1.5 text-xs sm:text-sm font-[family-name:var(--font-dm-sans)] text-[#F0F4FF]"
              >
                {f}
              </span>
            ))}
        ...
        {/* CTA */}
        <div className="rounded-md border border-[#1E2E45] bg-[#0F1A2E] p-6 sm:p-8">
          <p className="mb-2 font-[family-name:var(--font-syne)] text-lg sm:text-xl font-semibold text-[#F0F4FF]">
            Request a Demo
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/contact"
              className="w-full sm:w-auto text-center rounded-md bg-[#2D7DFA] px-5 py-2.5 text-sm font-[family-name:var(--font-dm-sans)] font-medium text-white hover:bg-[#2D7DFA]/90 transition-colors"
            >
              Request a Demo
            </Link>
            <Link
              href="/contact"
              className="w-full sm:w-auto flex items-center justify-center gap-1.5 rounded-md border border-[#1E2E45] px-5 py-2.5 text-sm font-[family-name:var(--font-dm-sans)] font-medium text-[#F0F4FF] hover:border-[#2D7DFA]/50 hover:text-[#2D7DFA] transition-colors"
            >
