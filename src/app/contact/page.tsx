          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
            ...
            >
              <div>
                ...
                <h1 className="mb-4 font-[family-name:var(--font-syne)] text-4xl font-bold text-[#F0F4FF] md:text-5xl">
                  Start a Project
                </h1>
              ...
              <div className="rounded-md border border-[#1E2E45] bg-[#0F1A2E] p-6">
                ...
                <a
                  ...
                  className="flex items-center gap-2 rounded-md bg-[#2D7DFA] px-5 py-2.5 text-sm font-[family-name:var(--font-dm-sans)] font-medium text-white hover:bg-[#2D7DFA]/90 transition-colors w-fit"
                >
                  <Calendar size={15} />
                  Book a Call
                </a>
